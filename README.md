...
**NOTE**
This maintenance of this library has moved over to [Carcraftz](https://github.com/1395173231/poe-openai-proxy/fhttp). The only use for this repository is so imports will not break.
